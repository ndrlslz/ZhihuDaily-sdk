...
public class ServiceCallAdapterFactory extends CallAdapter.Factory {
    ...
    public CallAdapter<?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
        ...
        if (!(returnType instanceof ParameterizedType)) {
            throw new IllegalStateException("ServiceCall return type must be parameterized"
                    + " as ServiceCall<Foo> or ServiceCall<? extends Foo>");
        }
    ...
    private static class BodyCallAdapter implements CallAdapter<ServiceCall<?>> {
        ...
        @Override
        public <R> ServiceCall<R> adapt(final Call<R> call) {
            return new ServiceCall<R>() {
                @Override
    ...
    private static class ResponseCallAdapter implements CallAdapter<ServiceCall<?>> {
        private final Type responseType;
        ...
        @Override
        public <R> ServiceCall<Response<R>> adapt(final Call<R> call) {
            return new ServiceCall<Response<R>>() {
                @Override
